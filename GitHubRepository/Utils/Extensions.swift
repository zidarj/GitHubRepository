...
extension UIImageView {
    ...
    func setImage(from imageURL: URL?, placeholder: UIImage?, activityIndicator: SDWebImageActivityIndicator? = .medium, completed: ((UIImage?) -> Void)? = nil) {
        ...
        sd_setImage(
            ...
            options: [SDWebImageOptions.continueInBackground], progress: nil) { (image, error, _, url) in
