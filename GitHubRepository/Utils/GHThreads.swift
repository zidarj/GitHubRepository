...
public enum GHBackgroundThreadPriority {
    case background
    case user_initiated
...
public func OnBackgroundThreadWith(_ priority: GHBackgroundThreadPriority, _ block: @escaping (() -> Void) ) {
    switch priority {
    case .background:
...
public func OnBackgroundThreadIfNeeded(withPriority priority: GHBackgroundThreadPriority,
