...
import UIKit
final class GHNavigationController: UINavigationController {
...
class GHViewController: UIViewController {
    ...
    private lazy var progressIndicator: GPProgressView = {
        return GPProgressView(frame: view.bounds)
    }()
...
extension GHViewController: UIGestureRecognizerDelegate {
    func gestureRecognizerShouldBegin(_ gestureRecognizer: UIGestureRecognizer) -> Bool {
        return navigationController?.viewControllers.count ?? 0 > 1
    }
}

private class GPProgressView: UIView {
